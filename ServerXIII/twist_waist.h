...
/*
            <tw default="tw_param">
                <tw_param type="group">
                    <totalCount abbreviation="t" type="int" default="24000"/>
                    <pitchMax abbreviation="p" type="double" default="15"/>
                    <rollMax abbreviation="r" type="double" default="15"/>
                    <diameter abbreviation="d" type="double" default="0.15"/>
                    <height abbreviation="h" type="double" default="0.04"/>
                </tw_param>
            </tw>
*/
